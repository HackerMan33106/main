...
function Kavo.CreateLib(kavName, themeList)
    ...
    Main.Size = UDim2.new(0, 545, 0, 347)
    ...
    close.Position = UDim2.new(0.99, 0, 0.137999997, 0)
    ...
    tabFrames.Position = UDim2.new(0, 0.6, 0, 0)
    tabFrames.Size = UDim2.new(0, 150, 0, 283)
    ...
    pages.Position = UDim2.new(0.3, 0, 0.123, 0)
    pages.Size = UDim2.new(0, 370, 0, 295)
