...
local Window = Library.CreateLib("Roblox Is Unbreakable V1.3 - Phantom Blood - AutoFarm", "RJTheme7")

-- 1 Section Enemy AutoFarm
local Tab = Window:NewTab("Auto farming enemies")
...
Section:NewToggle("Enable/disable auto farming of enemies", "On/off automatic farming of enemies.", function(AFE)
    if AFE then
        if selectedEnemy then
            isEnabled = true
...
local enemyDropdown = Section:NewDropdown("Choose an enemy", "Choosing which enemy to farm.", {}, function(enemy)
    selectedEnemy = enemy
end)
...
Section:NewButton("Reload the list", "Reloading the enemy list.", function()
    updateEnemyList(enemyDropdown)
end)

Section:NewButton("Reset the selected enemy", "Reset the currently selected enemy.", function()
    selectedEnemy = nil
end)
...
local Tab = Window:NewTab("Auto farming players")
local Section = Tab:NewSection("Auto farm")
...
Section:NewToggle("On/off auto farming of players", "On/off automatic player farming.", function(AFE)
    if AFE then
        if selectedPlayer then
            isEnabled = true
            initialPosition = humanoidRootPart.CFrame
...
local playerDropdown = Section:NewDropdown("Select a player", "Choosing which player to farm.", {}, function(player)
...
Section:NewButton("Reload the list", "Reloading the player list.", function()
    updatePlayerList(playerDropdown)
end)

Section:NewButton("Reset selected player", "Reset the currently selected player.", function()
    selectedPlayer = nil
end)
...
-- 3 Section More Info
local Tab = Window:NewTab("More info")
local Section = Tab:NewSection("More information")

Section:NewLabel("If your character is missing: Re-enter the server")
Section:NewLabel("")
Section:NewLabel("Remember, this autofarm is only beta.")
Section:NewLabel("And it may have bugs")
